...
#  A testunit represents an individual function or method to be run by the AWSCliTestRunner class.
##################################################################################################
...
class TestUnit(object):
    ...
    def __init__(self, method, html_anchors=False, test_unit_name=None, test_logger=None,
        ...
        self.method = method
        self.method_possible_args = AWSCliTestRunner.get_meth_arg_names(self.method)
        self.args = args
        self.kwargs = kwargs
...
class AWSCliTestRunner(object):
    ...
    def format_testunit_method_arg_values(cls, testunit):
        buf = testunit.name + "("
        argdict = AWSCliTestRunner.get_testunit_method_arg_dict(testunit)
        for arg in argdict:
